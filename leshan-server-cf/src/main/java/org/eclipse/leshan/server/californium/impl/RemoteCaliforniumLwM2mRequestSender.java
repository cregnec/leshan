...
public class RemoteCaliforniumLwM2mRequestSender implements LwM2mRequestSender {
     ...
     */
    public RemoteCaliforniumLwM2mRequestSender(Set<Endpoint> endpoints, RemoteObservationServiceImpl observationService,
    ...
    public <T extends LwM2mResponse> T send(final Registration destination, final DownlinkRequest<T> request,
        ...
        SyncRequestObserver<T> syncMessageObserver = new SyncRequestObserver<T>(coapRequest, timeout) {
            ...
            public T buildResponse(Response coapResponse) {
                ...
                RemoteLwM2mResponseBuilder<T> lwm2mResponseBuilder = new RemoteLwM2mResponseBuilder<>(coapRequest,
