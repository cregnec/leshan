...
public class RemoteLwM2mResponseBuilder<T extends LwM2mResponse> implements DownlinkRequestVisitor {

    private static final Logger LOG = LoggerFactory.getLogger(RemoteLwM2mResponseBuilder.class);
    ...
    public RemoteLwM2mResponseBuilder(Request coapRequest, Response coapResponse, Registration registration,
            LwM2mModel model, RemoteObservationServiceImpl observationService, LwM2mNodeDecoder decoder) {
        ...
        case CONTENT:
            ...
            if (coapResponse.getOptions().hasObserve()) {
                ...
                try {
                    ...
                    LOG.error("Failed to add observation via RMI", e);
                }
