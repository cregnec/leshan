 ...
 * </p>
 * <p>
 * The {@link LeshanServerBuilder} should be the preferred way to build an instance of {@link RemoteLeshanServer}.
 * </p>
 */
public class RemoteLeshanServer implements RemoteLwM2mServer {

    private final CoapServer coapServer;

    private static final Logger LOG = LoggerFactory.getLogger(RemoteLeshanServer.class);
    ...
    public RemoteLeshanServer(InetSocketAddress localAddress, RemoteCaliforniumRegistrationStore registrationStore,
        ...
        // define /rd resource
        RemoteRegisterResource rdResource = new RemoteRegisterResource(
                new RemoteRegistrationHandler(this.registrationService, authorizer));
