 ...
 */
public class RemoteRegistrationHandler {

    private static final Logger LOG = LoggerFactory.getLogger(RemoteRegistrationHandler.class);

    private RemoteRegistrationServiceImpl registrationService;
    private Authorizer authorizer;

    public RemoteRegistrationHandler(RemoteRegistrationServiceImpl registrationService, Authorizer authorizer) {
    ...
    public SendableResponse<RegisterResponse> register(Identity sender, RegisterRequest registerRequest,
        ...
        Registration.Builder builder = new Registration.Builder(RemoteRegistrationHandler.createRegistrationId(),
