 ...
 */
public interface RemoteRegistrationStore extends Remote {
     ...
     */
    Deregistration addRegistration(Registration registration) throws RemoteException;
     ...
     */
    UpdatedRegistration updateRegistration(RegistrationUpdate update) throws RemoteException;
     ...
     */
    Registration getRegistration(String registrationId) throws RemoteException;
     ...
     */
    Registration getRegistrationByEndpoint(String endpoint) throws RemoteException;
     ...
     */
    Registration getRegistrationByAdress(InetSocketAddress address) throws RemoteException;
     ...
     */
    Deregistration removeRegistration(String registrationId) throws RemoteException;
     ...
     */
    Collection<Observation> addObservation(String registrationId, Observation observation) throws RemoteException;

    /**
     * Get the observation for the given registration with the given observationId
     */
    Observation getObservation(String registrationId, byte[] observationId) throws RemoteException;

    /**
     * Remove the observation for the given registration with the given observationId
     */
    Observation removeObservation(String registrationId, byte[] observationId) throws RemoteException;

    /**
     * Get all observations for the given registrationId
     */
    Collection<Observation> getObservations(String registrationId) throws RemoteException;

    /**
     * Remove all observations for the given registrationId
     */
    Collection<Observation> removeObservations(String registrationId) throws RemoteException;

    /**
     * set a listener for registration expiration.
     */
    void setExpirationListener(ExpirationListener listener) throws RemoteException;
}
