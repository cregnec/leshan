 ...
 */
public interface RemoteObservationService extends Remote {
     ...
     */
    int cancelObservations(Registration registration) throws RemoteException;
     ...
     * @return the number of canceled observations
     */
    int cancelObservations(Registration registration, String resourcepath) throws RemoteException;
     ...
     */
    void cancelObservation(Observation observation) throws RemoteException;
