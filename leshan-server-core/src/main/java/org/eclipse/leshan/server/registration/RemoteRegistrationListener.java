 ...
 */
public interface RemoteRegistrationListener extends Remote {
     ...
     */
    void updated(RegistrationUpdate update, Registration updatedReg, Registration previousReg) throws RemoteException;
