...
public interface RemoteObservationListener extends Remote {

    void newObservation(Observation observation, Registration registration) throws RemoteException;

    void cancelled(Observation observation) throws RemoteException;
     ...
     *        </ul>
     */
    void onError(Observation observation, Registration registration, Exception error) throws RemoteException;
}
